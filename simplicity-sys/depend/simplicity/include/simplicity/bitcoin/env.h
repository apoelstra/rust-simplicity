...
/* This section builds the 'rawTransaction' structure which is the transaction data needed to build a Bitcoin 'txEnv' environment
 * for evaluating Simplicity expressions within.
 * The 'rawTransaction' is copied into an opaque 'bitcoinTransaction' structure that can be reused within evaluating Simplicity on multiple
